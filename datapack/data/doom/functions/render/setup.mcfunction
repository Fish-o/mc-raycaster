...
summon minecraft:block_display -1.1 74.0 -2.0 {Tags: ["doom_render", "rd_backdrop_ceiling"], block_state: {Name: "minecraft:gray_concrete"}, brightness: {sky: 0, block: 4}}
data modify entity @e[tag=rd_backdrop_ceiling,limit=1] transformation.scale set value [0.1f, 2f, 5f]
summon minecraft:block_display -1.1 72.0 -2.0 {Tags: ["doom_render", "rd_backdrop_floor"], block_state: {Name: "minecraft:light_gray_concrete"}, brightness: {sky: 0, block: 15}}
data modify entity @e[tag=rd_backdrop_floor,limit=1] transformation.scale set value [0.1f, 2f, 5f]
