#> 
# make sure to run with {rot_pos}
$data modify storage doom:logic consts.rot_pos set value $(rot_pos)f
data modify entity @e[limit=1,tag=m_sin_calculator] Rotation[0] set from storage doom:logic consts.rot_pos
...
scoreboard players set @e[tag=m_dirX] m_reg 0
...
scoreboard players set @e[tag=m_wm] m_reg 500
...
scoreboard players set @e[tag=m_dirZ] m_reg 0
...
scoreboard players set @e[tag=m_planeX] m_reg 666
...
scoreboard players set @e[tag=m_planeZ] m_reg 666
